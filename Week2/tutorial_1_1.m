...
% Add a column of ones to the testing input data for the intercept term
Xtest = [ones(size(xTest,1),1) xTest];

% Calculate the predicted output for the testing input data
yTestPred = Xtest * theta;

% Calculate the mean squared error on the test set
mse = mean((yTestPred - yTest).^2);

% Create a histogram plot of the error
ploterrhist((yTestPred - yTest));