...
max_iter = 1e3;  % maximum iter to prevent infinite loop
iter = 0;
idx = 0;
...
while true
    % Try to randomize the x_i and y_i, 
    ...
    elseif iter >= max_iter
        disp('Maximum iterations achieved but no convergence happens.')
        break;
    end
